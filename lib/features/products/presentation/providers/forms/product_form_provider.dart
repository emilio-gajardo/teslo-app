...
final productFormProvider = StateNotifierProvider.autoDispose.family<ProductFormNotifier, ProductFormState, Product>(
  (ref, product) {
    ...
    final createUptadeCallback = ref.watch(productsProvider.notifier).createOrUpdateProduct;

    return ProductFormNotifier(
      product: product,
      onSubmitCallback: createUptadeCallback,
    );
  }
);
...
class ProductFormNotifier extends StateNotifier<ProductFormState> {
  ...
  /// metodo para forzar que todos los campos esten manipulados
  ...
  /// - Inputs con reglas de validación para cuando cambie el [titulo/nombre]
  ...
  /// - Inputs con reglas de validación para cuando cambie el [price]
  ...
  /// - Inputs con reglas de validación para cuando cambie el [stock]
