...
class ProductScreen extends ConsumerWidget {
  ...
  /// - snackbar para mostrar mensaje al usuario al actualizar producto
          ...
          actions: [
            ...
            IconButton(
              onPressed: () async {
                ...
                if(kDebugMode) print('>> selectPhoto() = $photoPath');
            ...
            IconButton(
              onPressed: () async {
                ...
                if(kDebugMode) print('>> takePhoto() = $photoPath');
                photoPath;
              },
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            ...
            ref.read(productFormProvider(productState.product!).notifier)
              ...
              .then((value) {
                if (!value) return;
                showSnackbar(context);// mostrar snackbar en mensaje de actualizacion de producto
              });
            // print(">> Clic boton save");
          },
      ...
      child: Column(
        ...
        children: [
          ...
          _SizeSelector(
            ...
            onSizesChanged: (value) => ref.read(productFormProvider(product).notifier).onSizeChanged(value),
          ),
          ...
          _GenderSelector(
            ...
            onGenderChanged: (value) => ref.read(productFormProvider(product).notifier).onGenderChanged(value),
          ),
          ...
          CustomProductField( 
            ...
            onChanged: (value) => ref.read(productFormProvider(product).notifier).onDescriptionChanged(value),
          ),
  ...
  Widget build(BuildContext context) {
    return SegmentedButton(
      ...
      onSelectionChanged: (newSelection) {
        ...
        // if(kDebugMode) print('>> newSlection: $newSelection');
      },
